...
focus:    壊れにくいWebアプリケーション設計
strength: 品質保証の視点 × フロントエンド / バックエンド開発
```

WebサービスのQAエンジニアとして、テスト設計・自動化・品質保証に従事。  
その経験を土台に、現在は **フルスタックWebエンジニアへの転向を目指して開発を学習中**。

> 「動くだけ」ではなく、「壊れにくい」設計を追い求めています。

**得意領域:**
- 🔍 Webサービス品質保証 / テスト設計・実行
- ⚡ E2Eテスト自動化（Playwright / Selenium）
- 🛠 Webアプリケーション設計・開発
